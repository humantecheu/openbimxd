...
class IfcToLabel:
    ...
    def get_inliers_conv_hull(self, ifc_element):
    ...
    def edit_labels(self, ifc_objects, semantic_label, use_conv_hull=False):
    ...
    def parse_curtain(self):
        ...
        print("-- Curtain walls not implemented, passing ...")
